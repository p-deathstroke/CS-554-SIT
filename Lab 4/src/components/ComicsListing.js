					...
					<Link to={`/comics/${comics.id}`}>
						<CardContent>
							...
							<Typography variant="body2" color="textSecondary" component="p">
								Characters Available: {comics.characters.available}
								<br />
								Creators Available: {comics.creators.available}
								<br />
								Stories Available: {comics.stories.available}
								<br />
								Events Available: {comics.events.available}
								<br />
		...
		return (
			<div>
				...
				{page === 0 ? (
					...
					<Link to={`/comics/page/${page - 1}`} onClick={decr}>
						PREV...
						<br />
					</Link>
				)}
				{lspg === true ? (
					...
					<Link to={`/comics/page/${page + 1}`} onClick={incr}>
						NEXT...{" "}
					</Link>
				)}
				<br />
